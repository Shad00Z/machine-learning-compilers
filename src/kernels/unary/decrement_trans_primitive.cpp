...
void mini_jit::kernels::unary::internal::decrementM3N4( mini_jit::Kernel &kernel )
{
    kernel.add_instr({
        ...
        fsubVec(v18, v18, v21, s2),
        fsubVec(v19, v19, v21, s2),
                                                       ...
                                                       int mLoopIterations )
{
    ...
    kernel.add_instr({
        ...
        // Increment values
        fsubVec(v8, v8, v21, s2),
        fsubScalar(v4, v4, v22, s),
        fsubVec(v9, v9, v21, s2),
        fsubScalar(v5, v5, v22, s),
        fsubVec(v10, v10, v21, s2),
        fsubScalar(v6, v6, v22, s),
        fsubVec(v11, v11, v21, s2),
        fsubScalar(v7, v7, v22, s),
                                                       ...
                                                       int mLoopIterations )
{
    ...
    kernel.add_instr({
        ...
        // Increment values
        fsubVec(v4, v4, v21, s2),
        fsubVec(v5, v5, v21, s2),
        fsubVec(v6, v6, v21, s2),
        fsubVec(v7, v7, v21, s2),
                                                       ...
                                                       int mLoopIterations )
{
    ...
    kernel.add_instr({
        ...
        // Increment values
        fsubScalar(v0, v0, v22, s),
        fsubScalar(v1, v1, v22, s),
        fsubScalar(v2, v2, v22, s),
        fsubScalar(v3, v3, v22, s),
...
void mini_jit::kernels::unary::internal::decrementM2N2( mini_jit::Kernel &kernel )
{
    kernel.add_instr({
        ...
        // Increment values
        fsubVec(v2, v2, v21, s2),
        fsubVec(v3, v3, v21, s2),
