...
// TEST_CASE("Tests the matmul_m_n_k microkernel function with random matrices and M=16", "[matmul_M16_N4_k]")
// {
//     const int M = 16;
//     const int N = 4;
//     const int K = 1;
...
TEST_CASE("Tests the matmul_m_n_k microkernel function with random matrices and M=17, N=8 and K=64", "[matmul_M17_N8_K64]")
{
    const int M = 16;
    const int N = 8;
    const int K = 1;
